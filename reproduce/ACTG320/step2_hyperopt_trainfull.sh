...
#SBATCH --output=/project/Stat/s1155202253/myproject/survgen-clinical-trials/reproduce/ACTG320/logs/step2_hyperopt_trainfull_%A_%a.out
#SBATCH --error=/project/Stat/s1155202253/myproject/survgen-clinical-trials/reproduce/ACTG320/logs/step2_hyperopt_trainfull_%A_%a.err
#SBATCH --array=0-5
