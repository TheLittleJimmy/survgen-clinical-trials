...
#SBATCH --output=/project/Stat/s1155202253/myproject/pfizer_projects/survgen-clinical-trials/reproduce/ACTG320/logs/step1_hyperopt_traincontrol_%A_%a.out
#SBATCH --error=/project/Stat/s1155202253/myproject/pfizer_projects/survgen-clinical-trials/reproduce/ACTG320/logs/step1_hyperopt_traincontrol_%A_%a.err
#SBATCH --array=0-5
